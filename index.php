...
if(isset($_POST['login'])){
	...
	$data_akses = mysqli_query($koneksi, "SELECT * FROM tbl_dpt WHERE nim='$nim' and kode_akses='$kode_akses'");
...
<html lang="en">
			<head>
				...
				<meta itemprop="description" content="Saatnyamemilih.online merupakan aplikasi praktis yang digunakan untuk pemilihan online berbasis web" />
					...
					<div class="container-login100">
						<div class="wrap-login100">
							...
							<form class="login100-form validate-form" action="" method="post">
								...
								<img src="images/voting.png" alt="saatnyamemilih.online" style="max-height:200px; width:auto;"> <br>
								HIMPUNAN MAHASISWA PENDIDIKAN EKONOMI<br>UNIVERSITAS PENDIDIKAN INDONESIA<br>
								</span>
								...
								<div class="text-center p-t-12">
									...
									<a class="txt2" href="https://www.youtube.com/channel/UCOAdMyFuPTcmi1TExyynO6w">
